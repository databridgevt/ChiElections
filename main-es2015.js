...
let AppComponent = class AppComponent {
    ...
    openDialog() {
        const dialogRef = this.dialog.open(_login_dialog_login_dialog_component__WEBPACK_IMPORTED_MODULE_4__["LoginDialogComponent"], {
            width: '250px',
